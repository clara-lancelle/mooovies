...
<main class="form">
    ...
    <form action="" method="POST" name="registration" class="form--center">
        <fieldset class="floating">
            ...
            <p class="error" <?php echo isset($formErrors['username']) ?: 'hidden' ?>>
                <?= $formErrors['username'] ?>
            </p>
        ...
        <fieldset class="floating">
            ...
            <p class="error" <?= isset($formErrors['password']) ?: 'hidden' ?>>
                <?= @$formErrors['password']; ?>
            </p>
        ...
        <fieldset class="floating">
            ...
            <p class="error" <?= isset($formErrors['confirmPassword']) ?: 'hidden' ?>>
